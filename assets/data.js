...
window.TRIP_DATA = {
  ...
  itinerary: [
    ...
    },
    {
      ...
      notes: '賽前兩天，走路觀光即可，不要久站操腿。報到拿物資、確認賽事動線。自費藍光蟲晚餐後出發、約晚間 10–11 點回飯店；國家公園每天限 300 名，務必先跟領隊預約。明早還有熱氣球要早起，今晚睡眠偏短，靠 7/4 午覺補回來。',
    },
    {
      ...
      stay: 'Mercure Gold Coast Resort',
      notes: '熱氣球清晨摸黑出發、搭完回飯店再吃早餐，看天氣（氣流不穩會取消）。全馬前一天：白天少站操腿，中午補個午覺把昨晚藍光蟲＋今早熱氣球的早起補回來；晚上吃好喝足、裝備全部攤開檢查、早睡，腿留給明天。',
    },
    {
